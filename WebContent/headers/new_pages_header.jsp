    	...
    	<div class="row">
    		<div class="col-sm-3 col-md-2 sidebar">
	          <ul class="nav sidebar-nav">
	            ...
	            <li>
	              <a href="#" data-toggle="collapse" data-target="#dd-menu" class="collapsed active" role="button" aria-haspopup="true" aria-expanded="false">drop down 4<span class="caret"></span></a>
	              <ul id="dd-menu" class="collapse">
